...
(function (window, document, plupload, $, undef) {
                                ...
                                '<div class="plupload">' +
                                        ...
                                        '<div class="plupload_content">' +
                                                ...
                                                '<tr class="ui-widget-header plupload_filelist_header">' +
                                                        ...
                                                        '<td class="plupload_cell plupload_file_custom">' + _('custom') + '</td>' +
    ...
    $.widget("ui.plupload", {
        ...
        _handleFileStatus: function (file) {
            ...
            actionClass += ' ui-widget-content plupload_file';

            $('#' + file.id)
                    .attr('class', actionClass)
                    .find('.plupload_file_action .ui-icon')
        ...
        _updateFileList: function () {
            ...
            $.each(up.files, function (i, file) {
                ...
                //ahmad
                var tr = $('<tr class="ui-widget-content plupload_file" id="' + file.id + '">' +
                                '<td class="plupload_cell plupload_file_name"><span>' + file.name + '</span></td>' +
                                '<td class="plupload_cell plupload_file_custom"></td>' +
                ...
                self._handleFileStatus(file, file);
                ...
                if (up.settings.CustomFiledList && $.isFunction(up.settings.CustomFiledList)) {
                    up.settings.CustomFiledList.call(this, filelist, file)
                }
