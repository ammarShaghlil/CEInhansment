...
//				this.tree.logDebug("nodeTitle: " + nodeTitle);
			    ...
			    var classsname;
			    if ($(this.span).find('a').length) classsname = $(this.span).find('a')[0].className;
			    else {
			        var classsname = opts.classNames.title;
			        if (data.focus) classsname += " ui-state-default";
			        if (data.activate) classsname += " ui-state-active";
			        if (data.select) classsname += " ui-state-highlight"; 
			    }
			    nodeTitle = '<a href="' + href + '" class="' + classsname + '"' + tooltip + '>' + data.title + '</a>';
			}
		}
		res += nodeTitle;
		return res;
...
//		this.tree.logDebug("dtnode.focus(): %o", this);
	...
	_activate: function(flag, fireEvents) {
		...
		if( flag ) {
			...
			$(this.span).addClass(opts.classNames.active).find("a").addClass("ui-state-active");
			...
			if( this.tree.activeNode === this ) {
				...
				$(this.span).removeClass(opts.classNames.active).find("a").removeClass("ui-state-active");
				if( opts.persist ) {
...
//        this.tree._changeNodeList("select", this, sel);
		...
		if( sel ) {
			...
			$(this.span).addClass(opts.classNames.selected).find("a").addClass("ui-state-highlight");
			...
			$(this.span).removeClass(opts.classNames.selected).find("a").removeClass("ui-state-highlight");
...
//		this.tree.logDebug("dtnode._onFocus(%o): %o", event, this);
		...
		if ( event.type == "blur" || event.type == "focusout" ) {
			...
			if( this.tree.tnFocused ){
			    $(this.tree.tnFocused.span).removeClass(opts.classNames.focused).find("a").removeClass("ui-state-default");;
			}
			...
			$(this.tree.tnFocused.span).addClass(opts.classNames.focused).find("a").addClass("ui-state-default");
...
//		secure: true
	...
	classNames: {
	    ...
	    title: "dynatree-title ui-corner-all",
